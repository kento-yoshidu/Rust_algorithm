...
fn run(n: usize, _m: usize, a: Vec<Vec<usize>>) -> usize {
...
mod tests {
    ...
    fn abc303_b() {
        let tests = [
            TestCase(4, 2, vec![vec![1, 2, 3, 4], vec![4, 3, 1, 2]], 2),
            TestCase(3, 3, vec![vec![1, 2, 3], vec![3, 1, 2], vec![1, 2 ,3]], 0),
            TestCase(10, 10, vec![
