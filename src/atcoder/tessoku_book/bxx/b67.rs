...
fn run(n: usize, _m: usize, abc: Vec<(usize, usize, usize)>) -> usize {
    let abc: Vec<(usize, usize, usize)> = abc.into_iter().sorted_by(|a, b| b.2.cmp(&a.2)).collect();
...
mod tests {
    ...
    fn tessoku_a67() {
        let tests = [
            TestCase(7, 9, vec![ (1, 2, 12), (1, 3, 10), (2, 6, 160), (2, 7, 15), (3, 4, 1), (3, 5, 4), (4, 5, 3), (4, 6, 120), (6, 7, 14)], 321),
        ];
