...
#[allow(dead_code)]
pub fn run(h: usize, w: usize, x_vec: Vec<Vec<usize>>, q: usize, a: Vec<Vec<usize>>) -> Vec<usize> {
...
mod tests {
    ...
    #[test]
    fn test() {
        assert_eq!(vec![25, 56], run(5, 5, vec![vec![2, 0, 0, 5, 1], vec![1, 0, 3, 0, 0], vec![0, 8, 5, 0, 2], vec![4, 1, 0, 0, 6], vec![0, 9, 2, 7, 0]], 2, vec![vec![2, 2, 4, 5], vec![1, 1, 5, 5]]));
    }
}
